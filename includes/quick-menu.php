<div class="container">
  <div class="row g-3 mt-1">
    ...
    <div class="col-6 col-md-3">
      <div class="icon-card">
        <a href="https://drive.google.com/file/d/15FQAByBsXgFBI6ZVxm1asIK60u3rugec/view?usp=drive_link" class="text-center">
    ...
    <div class="col-6 col-md-3">
      <div class="icon-card">
        <a href="my-wallet.php" class="text-center">
          <i class='fa fa-wallet' aria-hidden="true" style='font-size:20px'></i><br>
          <span>My Wallet</span>
        </a>
      </div>
    </div>
