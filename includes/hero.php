...
$site_url = "https://theearnmax.com/signup.php?ref=" . $referral_code; // Change to your actual site URL
?>
<!-- Header Banner -->
        ...
        <div id="appCarousel" class="carousel slide mt-3" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="images/slide-1.webp" class="d-block w-100" alt="Slide 1" >
            </div>
            <div class="carousel-item">
              <img src="images/slide-3.webp" class="d-block w-100" alt="Slide 2">
            </div>
             <div class="carousel-item">
              <img src="images/slide-2.webp" class="d-block w-100" alt="Slide 2">
            </div>
          </div>
