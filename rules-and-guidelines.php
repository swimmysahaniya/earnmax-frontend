    ...
    <div class="tab-content" id="rulesTabContent">
        ...
        <div class="tab-pane fade show active" id="joining" role="tabpanel">
            <div class="card p-4">
                ...
                <p>✅ Refer <strong>3 new members</strong> and get <strong>100% refund</strong> of your initial investment.</p>
        ...
        <?php if (!empty($income_list)) { ?>
            ...
            <table class="table">
                ...
                <?php foreach ($income_list as $income) { ?>
                    <tr>
                        <td><?php echo "₹ " . number_format($income['total_referred_investment'], 2); ?></td>
                        <td><?php echo "₹ " . number_format($income['monthly_income'], 2); ?></td>
                        <td>
                            <?php
                                if ($income['status'] == '0') {
                                    echo 'Pending';
